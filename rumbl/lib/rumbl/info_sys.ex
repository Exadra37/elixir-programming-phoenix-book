defmodule Rumbl.InfoSys do
  ...
  $ iex -S mix
    -> Rumbl
        -> Rumbl.InfoSys.Supervisor.start_link/0

  iex> Rumbl.InfoSys.compute("what is elixir?")
    -> Rumbl.InfoSys.compute/2
        -> Rumbl.InfoSys.spawn_query/3
            -> Rumbl.InfoSys.Supervisor.init/1
                -> Rumbl.InfoSys.start_link/5
                    -> Rumbl.InfoSys.Wolfram.start_link/4
                        -> Rumbl.InfoSys.Wolfram.fetch/4
            -> Rumbl.InfoSys.await_results/2
                -> Rumbl.InfoSys.await_result/3 <-
  """
  ...
  for example Rumbl.InfoSys.Wolfram.start/4.

  So whenever in spawn_query/3 the Supervisor starts a child, this function will
  be invoked.

  This will be called by the Rumbl.InfoSys.Supervisor.init/1 in order to  be
  ...
  # it was registered in Rumbl.InfoSys.Supervisor.init/1.
  #
